# CutLog Waitlist Outreach - Facebook Groups Campaign

## Overview
Multi-template Facebook outreach targeting 16 laser operator communities. Three post variants tailored to audience segments (general cutting, engraving-focused, Chinese machine operators).

---

## Post Templates

### Template #1: General/Cutting-Focused Groups
...
### Template #2: Engraving/PMAG-Focused Groups
...
### Template #3: Chinese Machine / Budget-Conscious Groups
...
## Engagement Plan (First Hour After Each Post)

### Active Monitoring
1. Set phone reminder for 60 minutes after posting
2. Monitor comments in real-time
3. Respond to **every** comment within 15 minutes of posting
...
- Conversion rate (comments → waitlist clicks)
- Sentiment ratio (positive/neutral/skeptical)
...
- **Positive sentiment:** >70% of comments
...
4. **Plan repost:** In 5-7 days, try different template or timing

### Attribution & Iteration
- **Track by UTM parameter:** Use `?group=group-name` on landing page links
- **Which groups convert best:** Prioritize for future campaigns
- **Which templates win:** Replicate winning copy across campaigns
...
- [ ] UTM parameters added to all post links
- [ ] Facebook group memberships verified (16 groups accessible)
- [ ] Post templates copied to notes/drafts (for quick pasting)
- [ ] Engagement plan printed/bookmarked (for live monitoring)
- [ ] Best posting times aligned with your timezone
