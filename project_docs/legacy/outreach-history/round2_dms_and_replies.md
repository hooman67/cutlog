...
# Round 2 — Facebook DM Drafts (Discovery Conversations)

## Strategy

These are cold DMs to people who commented on Matt's post about finding parameters for Chinese fiber lasers. The goal is NOT to pitch — it's to ask a genuine follow-up question that:
1. Shows you actually read and valued their specific comment
2. Opens a thread about their workflow
3. Positions you as someone building in this space (without selling anything yet)

Keep it under 5 sentences. Match their vibe — these are shop guys, not SaaS buyers.

---

## Jeremy Hubert

> Hey Jeremy — your point about each lens having its own signature really stuck with me. Quick question: when you're doing material tests for a new setup, do you have a system for logging what worked, or is it more of a mental thing where you just remember "this combo felt right"? I'm trying to understand how experienced operators actually track that stuff day to day.
...
> Hey Tinker — your comment about it usually just being speed that needs adjusting was one of the most useful things in that whole thread. When you say "closest parameters that we have" — is that stuff you've written down somewhere, or more like you just know which old job file to grab? Curious how operators with real experience actually organize that knowledge.
...
- Space them out — don't send all 5 in the same hour (looks bot-like if anyone compares notes)
- If someone replies with even one sentence, match their length and energy — don't escalate to a pitch
- Goal for this round: get 2-3 into a back-and-forth thread. A call invitation comes in message 3 or 4, not message 1
- If they don't reply within a week, leave it — no follow-up on a cold DM that got no response


## Replies to the messages above (2026-06-15)
### Jeremy Hubert
...
### Tinker Withit
Matt St so we have Raytool and there is a lot of parameters on the web, and we also have book that shows speed pressure height and such for various metals and thicknesses…so from there we can fill in the gaps


## more comments under the round2 post (2026-06-15)
### Joe Marx
For HSG use their customer service chat. Should be a QR code on the machine

### DIY Fiber Laser
#### Keith E. Fleming
I think part of the fun of owning industrial class equipment like this is that there's some Expectation on the part of the user to already be well versed in the machine's operation. It's not too difficult though to play around with the parameters using published parameters online as a good starting point.

---

## Follow-up Messages to Send (2026-06-16)

### To Jeremy Hubert (follow up on his .clb library usage — give context + onboard him):
**Goal:** Position as a fellow community member who built something for himself, not a startup founder pitching. The .clb import is the hook.

Nice. Smart to keep the tests saved. Most guys just remember "that one file from 6 months ago" and then can't find it 😂

In case you couldn't tell, I just got into laser cutting/engraving, partly for fun, partly as a side thing in case AI takes my job 😂. I'm a software guy so I couldn't resist building a little tool to help me remember what actually worked. Ended up turning it into something called CutLog, basically a searchable database of parameters + it can import your .clb file directly so all your saved settings are in one place.

Give it a look if you're curious: https://cutlog-two.vercel.app



Ok. I sent thim message above. 